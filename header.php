        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Vapour Statistics</a>
            </div>
            <div class="navbar-pagetitle">
                <h3>DASHBOARD
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="bhgpsc" class="collapse">
                            ...
                            <li><a href="tap-bhgpsc.html">Total Active Patients</a></li>
                        </ul>
                    </li><!-- bhgpsc -->
                    <li>
                        ...
                        <ul id="smc" class="collapse">
                            ...
                            <li><a href="tap-smc.html">Total Active Patients</a></li>
                        </ul>
                    </li><!-- smc -->
                    <li>
                        ...
                        <ul id="combined" class="collapse">
                            ...
                            <li><a href="tap-comb.html">Total Active Patients</a></li>
                        </ul>
                        <hr>
                    </li><!-- combined -->
                    <li>
                        ...
                        <ul id="admin" class="collapse">
                            ...
                            <li><a href="tap-admin.html">Total Active Patients</a></li>
                        </ul>
                    </li><!-- admin -->
                </ul>
            </div>
